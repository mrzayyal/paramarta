   <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="p-5">
        <form class="user" method="post" action="?psbad=simpanayah">
          ...
          <div class="form-group">
            Nama Ayah<br/>
            <input type="text" class="form-control nama" id="nama" name="nama" placeholder="Nama Ayah" >
          </div>
          ...
          <div class="form-group row">
            <div class="col-sm-3 mb-1 mb-sm-0">
              Pekerjaan Ayah<br>
              <input type="text" class="form-control pekerjaan" name="pekerjaan" id="pekerjaan" placeholder="pekerjaan Ayah">
            </div>
            <div class="col-sm-3">
              Pendidikan Ayah<br>
          ...
          <div class="form-group row">
            <div class="col-sm-3 mb-1 mb-sm-0">
              Penghasilan Bulanan Ayah<br>
              <input type="number" name="hasil" class="form-control hasil" id="hasil" min="0" data-bind="value:hasil" pattern="[0-9] {1,15}" title="Mohon Masukan Angka" placeholder="Penghasilan Ayah" >
            </div>
          </div>                  
